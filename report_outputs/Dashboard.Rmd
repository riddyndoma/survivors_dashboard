...
current_week=date2week(now(), numeric = TRUE)
...
g=ggplot(data=tb_comp_hs, aes(x=reorder(situation, -n), y=n, fill=situation,stat="identity")) +
  # geom_bar(stat="identity")+theme_classic(base_size = 12) +labs(x="",y="Effectifs", title = "", subtitle = )
  geom_bar(stat="identity")+theme_classic() +labs(x="",y="Effectifs", title = "", subtitle = )
g=g+geom_text( aes(label = n, y = n),position = position_dodge(0.9),vjust = 0)
...
Column {data-width=31%}
-----------------------------------------------------------------------
### Evolution psychologique du patient depuis la dernière visite(mois en cours)
...
# bp<- ggplot(tb_evol_hs, aes(x="", y=n, fill=situation))+
# geom_bar(width = 1, stat = "identity")
# pie <- bp + coord_polar("y", start=0)
# pie + scale_fill_brewer("Blues") + theme_minimal() +
